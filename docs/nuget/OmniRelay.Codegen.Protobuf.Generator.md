...
See `docs/reference/codegen/protobuf.md` for a complete walkthrough and `tests/OmniRelay.Codegen.Tests/Projects/ProtobufIncrementalSample` for a working sample.
