...
public class DispatcherTests
{
    ...
    {
        var dispatcher = new YARPCore.Dispatcher.Dispatcher(new DispatcherOptions("edge"));
    ...
    {
        var dispatcher = new YARPCore.Dispatcher.Dispatcher(new DispatcherOptions("streaming"));
    ...
    {
        var dispatcher = new YARPCore.Dispatcher.Dispatcher(new DispatcherOptions("frontend"));
    ...
    {
        var dispatcher = new YARPCore.Dispatcher.Dispatcher(new DispatcherOptions("keyvalue"));
